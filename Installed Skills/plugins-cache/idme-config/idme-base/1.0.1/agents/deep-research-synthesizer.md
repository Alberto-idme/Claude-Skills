...
3. Conduct web research for:
   - Current best practices
   - Recent developments
   - Community insights and discussions
   - Academic papers and technical specifications
4. Check the memory bank for previous related investigations
5. : Track source locations and citations for every piece of information
